<?php /* Smarty version 2.6.25, created on 2013-12-08 19:18:36
         compiled from content/views/admin.new-content.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'content/views/admin.new-content.tpl', 93, false),)), $this); ?>
...
?>
                        <li><a <?php if (! $this->_tpl_vars['fullPermisison'] && ($this->_foreach['langTab']['iteration'] <= 1)): ?>class="default-tab"<?php endif; ?> href="#tab<?php echo $this->_tpl_vars['item']['lang_id']; ?>
...
$this->_sections['images']['loop'] = is_array($_loop=50) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?> 
                                        <?php $this->assign('i', $this->_sections['images']['iteration']); ?> 
                                     <li <?php if ($this->_tpl_vars['i'] > 2 && $this->_tpl_vars['i'] > count($this->_tpl_vars['data']['images'])): ?>class="hidden"<?php endif; ?>>   
                                            <input type="hidden" id="chooseImage_input<?php echo $this->_tpl_vars['i']; ?>
" name="data[images][]">
                                            <div id="chooseImage_div<?php echo $this->_tpl_vars['i']; ?>
" style="display: none;">
                                                <img src="" id="chooseImage_img<?php echo $this->_tpl_vars['i']; ?>
