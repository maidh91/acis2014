...
<!--									</select>-->
                            		...
                            		{{foreach from=$allGroups item=item}}
                                		<option value="{{$item.group_id}}" {{if $data.groups.group_id == $item.group_id}}selected="selected"{{/if}}>{{$item.name}} ({{$item.count}})</option>
                            		{{/foreach}}
                            		</select>
                                </p>
                                ...
                                <p>
                                	...
                                	<textarea id="touser" class="text-input textarea wysiwyg" rows="5" cols="79" name="data[to_user]"></textarea>
                                </p>
                        		<br/>
